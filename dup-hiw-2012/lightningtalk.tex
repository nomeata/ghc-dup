...
\vfill
\onslide<6->{the programmer might want to avoid to have the list shared}
...
\hide
\onslide<7->
consumer, not generator controls sharing. no code restructuring
...
\path<5> (0,-5) node (t2') {T};
\path<6-> (0,-5) node (t2') {I};
...
\begin{frame}
\frametitle{We have formal semantics!}
