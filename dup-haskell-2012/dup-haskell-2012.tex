...
\begin{scope}
\path[use as bounding box] (0pt,-3em) -- (0pt,0em);
...
Immediate.
\case{$\sApp e x$}
From $\ufv{\sApp e x} = \ufv{e} \cup \{x\}$ and $U \cap \ur\Gamma{\sApp e x}= \emptyset$ we have $x\notin U$ and $U \cap \ur\Gamma e = \emptyset$. From the left inductive case we obtain $\Gamma_0 \subseteq \Delta$ and (i) $U \cap \ur\Gamma {\sLam y. e'}= \emptyset$.
